...
- (void) setBackgroundImage {
    ...
    NSString *backgrImgName = IS_IPAD ?  @"mandolin_ipad" : @"mandolin_iphone";
    
    UIImage *bgImage = [UIImage imageNamed:backgrImgName];
    CGSize screenSize = [UIScreen mainScreen].bounds.size;
    UIGraphicsBeginImageContextWithOptions(screenSize, NO, 0.f);
    [bgImage drawInRect:CGRectMake(0.f, 0.1*screenSize.height, screenSize.width, 0.8*screenSize.height)];
